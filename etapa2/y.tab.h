...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    KW_REAL = 260,                 /* KW_REAL  */
    KW_SE = 261,                   /* KW_SE  */
    KW_ENTAUM = 262,               /* KW_ENTAUM  */
    KW_SENAUM = 263,               /* KW_SENAUM  */
    KW_ENQUANTO = 264,             /* KW_ENQUANTO  */
    KW_ENTRADA = 265,              /* KW_ENTRADA  */
    KW_ESCREVA = 266,              /* KW_ESCREVA  */
    KW_RETORNE = 267,              /* KW_RETORNE  */
